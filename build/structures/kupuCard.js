...
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/circularstd-black.otf`,
  "circular-std",
);
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/notosans-jp-black.ttf`,
  "noto-sans-jp",
);
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/notosans-black.ttf`,
  "noto-sans",
);
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/notoemoji-bold.ttf`,
  "noto-emoji",
);
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/notosans-kr-black.ttf`,
  "noto-sans-kr",
);
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/Chewy-Regular.ttf`,
  "chewy",
);
canvas.GlobalFonts.registerFromPath(
  `node_modules/kupucard/build/structures/font/Space.ttf`,
  "space",
);
...
class kupuCard {
  ...
  async build() {
    ...
    if (!this.theme) this.setTheme("kupumalam");
    ...
    if (this.theme === "kupumalam") {
      ...
      const thumbnailMaskCanvas = canvas.createCanvas(
        thumbnailCanvas.width,
        thumbnailCanvas.height,
      );
    ...
    if (this.theme == "kupuonepiece") {
      ...
      throw new Error(
        'Invalid theme parameter, must be  one of "kupumalam" "kupuoneoiece" "kupuvector"',
      );
    }
  }
}
